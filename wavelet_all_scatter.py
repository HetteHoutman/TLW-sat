...
plt.hist(df1[f'lambda'], bins=lambdas_edges, label=name_1, density=True)
plt.hist(df2[f'lambda'], hatch='/', fill=False, bins=lambdas_edges, label=name_2, density=True)
...
plt.hist(df1[f'theta'], bins=thetas_edges, label=name_1, density=True)
plt.hist(df2[f'theta'], hatch='/', fill=False,  bins=thetas_edges, label=name_2, density=True)
...
hist_1 = np.histogram2d(df1[f'lambda'], df1[f'theta'], bins=[lambdas_edges, thetas_edges])
hist_1[0][hist_1[0]==0] = np.nan
hist_2 = np.histogram2d(df2[f'lambda'], df2[f'theta'], bins=[lambdas_edges, thetas_edges])
